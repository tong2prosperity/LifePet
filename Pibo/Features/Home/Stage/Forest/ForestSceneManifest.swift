...
enum ForestSceneManifest {
    ...
    static let foliage: [Foliage] = [
        Foliage(image: "forest_main_leaf_2", frame: CGRect(x: -33, y: 585, width: 210.1935, height: 259.6893), anchor: CGPoint(x: 0.48, y: 0.98), zPosition: 31, stiffness: 10.5, maximumAngle: 0.065, phase: 0.2, lightingGroup: .foreground),
        Foliage(image: "forest_main_leaf_1", frame: CGRect(x: 199.5819, y: 481, width: 283.4227, height: 367.4554), anchor: CGPoint(x: 0.74, y: 0.98), zPosition: 32, stiffness: 9.0, maximumAngle: 0.075, phase: 1.4, lightingGroup: .foreground),
        Foliage(image: "forest_front_leaf_2", frame: CGRect(x: -71, y: 740, width: 248, height: 128.53), anchor: CGPoint(x: 0.10, y: 0.92), zPosition: 35, stiffness: 12, maximumAngle: 0.05, phase: 2.2, lightingGroup: .foreground),
        Foliage(image: "forest_front_leaf_1", frame: CGRect(x: 11, y: 774, width: 279, height: 119.9522), anchor: CGPoint(x: 0.12, y: 0.92), zPosition: 36, stiffness: 11, maximumAngle: 0.05, phase: 3.0, lightingGroup: .foreground),
        Foliage(image: "forest_front_grass_1", frame: CGRect(x: 219.2007, y: 760, width: 70.6650, height: 91.0819), anchor: CGPoint(x: 0.50, y: 1), zPosition: 37, stiffness: 15, maximumAngle: 0.075, phase: 0.8, lightingGroup: .foreground),
        Foliage(image: "forest_front_grass_2", frame: CGRect(x: 261, y: 731.4669, width: 126.9644, height: 170.5405), anchor: CGPoint(x: 0.50, y: 1), zPosition: 38, stiffness: 13, maximumAngle: 0.085, phase: 1.9, lightingGroup: .foreground),
        Foliage(image: "forest_front_grass_3", frame: CGRect(x: 333, y: 747, width: 69.5622, height: 120.7878), anchor: CGPoint(x: 0.50, y: 1), zPosition: 39, stiffness: 14, maximumAngle: 0.085, phase: 2.8, lightingGroup: .foreground),
    ]
